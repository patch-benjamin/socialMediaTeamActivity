...
public class SocialMediaDemo implements Runnable {
    ...
    private void analyzeYouTubeVideos() {
        ...
        YouTubeeConverter cVideo1 = new YouTubeeConverter(video1);
        YouTubeeConverter cVideo2 = new YouTubeeConverter(video2);
        YouTubeeConverter cVideo3 = new YouTubeeConverter(video3);
